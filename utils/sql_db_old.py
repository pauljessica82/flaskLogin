...
class SqlDatabase:
    def __init__(self):
        ...
        engine = create_engine('postgresql://xvzbalntdzbbnc:9002638a555a62933e10ba27c5de3231bdcfa4ac799a5f8cce04793a6400b310@ec2-3-219-19-205.compute-1.amazonaws.com:5432/d42mi538okaaoj')
        self.conn = engine.connect()
        # self.conn = psycopg2.connect(
        #     user='xvzbalntdzbbnc',
        #     password='9002638a555a62933e10ba27c5de3231bdcfa4ac799a5f8cce04793a6400b310',
        #     host='ec2-3-219-19-205.compute-1.amazonaws.com',
        #     port='5432',
        #     database='d42mi538okaaoj'
        #
        # )
